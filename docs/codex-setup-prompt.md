# Codex Setup Prompt for Spectacular

Copy everything below this line and paste it into Codex CLI in your project.
...
Add a "Specification" section to this project's `AGENTS.md` at the repository root (create the file if it doesn't exist). Codex reads `AGENTS.md` files from the repo root down to your current directory.
...
Note: Codex uses `AGENTS.md` (not `CLAUDE.md`). If you need to temporarily override these instructions, create an `AGENTS.override.md` in the same directory.
